  ...
  <Container id="landing-page" fluid className="py-3 d-flex h-100">
    <Row className="justify-content-center align-items-center w-100">
      <Col xs={12} md={8} className="d-flex flex-column justify-content-center align-items-center text-center">
        ...
        <p>Users can browse our catalog of user submitted items, contact users with items of interest, or submit a found or lost item for other UHM students to view.
        </p>
      </Col>
    </Row>
  </Container>
