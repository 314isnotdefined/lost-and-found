...
const EditLostItem = () => {
  ...
  const submit = (data) => {
    const { itemName, image, category, lastSeen, contactEmail, description } = data;
    LostItems.collection.update(_id, { $set: { itemName, image, category, lastSeen, contactEmail, description } }, (error) => (error ?
