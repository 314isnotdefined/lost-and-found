...
import LostItemAdmin from '../components/LostItemAdmin';

const ListLostItemAdmin = () => {
        ...
        <Row className="justify-content-center">
          <Col>
            ...
            <Row xs={1} md={2} lg={3} className="g-4">
              {lostitems.map((item, index) => (<Col key={index}><LostItemAdmin item={item} /></Col>))}
            </Row>
          </Col>
        </Row>
      </Container>
...
export default ListLostItemAdmin;
